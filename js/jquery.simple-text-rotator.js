 ...
 *
 * ========================================================== */
function animateElement(el, properties, duration) {
  return new Promise((resolve, reject) => {
    el.animate(properties, duration, resolve);
  });
}
    ...
    return this.each(function () {
      ...
      var rotate = function () {
        switch (settings.animation) {
          case "dissolve":
            animateElement(el, { textShadowBlur: 20, opacity: 0 }, 1000)
              .then(() => {
